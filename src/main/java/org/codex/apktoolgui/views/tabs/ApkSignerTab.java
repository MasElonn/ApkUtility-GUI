...
import org.codex.apktoolgui.services.AaptService;
import org.codex.apktoolgui.services.ApkSignerService;
...
public class ApkSignerTab {
    ...
    private void showVerifyDialog(String apkPath) {
        ...
        dialog.getDialogPane().getStylesheets().add(
            getClass().getResource("/org/codex/apktoolgui/dark-theme.css").toExternalForm()
        );
